...
<aside class="sidebar" id="sidebar">
    ...
    <?php if ($role === 'cashier'): ?>
    <div style="margin:0 12px 12px;background:rgba(232,98,42,.1);border:1px solid rgba(232,98,42,.25);
                border-radius:8px;padding:8px 12px;font-size:.72rem;color:#e8622a;text-align:center">
        🧾 Cashier Mode
    </div>
    <?php endif; ?>
    ...
    <div class="sidebar-footer">
        ...
        <a href="<?= $root ?>logout.php" title="Logout"
           style="margin-left:auto;background:none;border:none;cursor:pointer;
                  color:var(--text-3);font-size:1.1rem;text-decoration:none;
